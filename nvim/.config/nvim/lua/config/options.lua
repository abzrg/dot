...
vim.opt.path = "**"
-- vim.opt.path = vim.opt.path + vim.fs.normalize("$HOME/.config/nvim")
...
vim.opt.statusline = [[%f %y %m %r%=%30(%l,%c   %P%)]]
vim.opt.textwidth   = 81 -- automatically hard wrap at 120 columns
