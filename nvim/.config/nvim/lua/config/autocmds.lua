...
--     vim.wo.cursorline = true
--     vim.cmd("hi EndOfBuffer guibg=#151515")
...
-- autocmd({ "WinLeave", "BufLeave", "WinNew" }, {
--   pattern = "*",
--   callback = function()
...
--     vim.cmd("hi EndOfBuffer guibg=#202020")
--     vim.cmd("hi VertSplit guibg=#202020")
--   end,
--   group = focus_group
-- })
--
