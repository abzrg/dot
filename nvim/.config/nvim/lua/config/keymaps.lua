...
-- caused me a lot of trouble typing ", as with this mapping in visual/select
-- mode will cause a havoc in snippet expansion
vim.keymap.set("x", '"', 'S"')
...
vim.keymap.set("n", "<leader>o", "<cmd>setlocal spell! spelllang=en_us<cr>", { silent = true })
